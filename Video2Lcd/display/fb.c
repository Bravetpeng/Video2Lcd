...
static int FBShowPage(PT_VideoBuf ptVideoMem);
 ...
 * 2013/02/08	     V1.0	  韦东山	      创建
 ***********************************************************************/
static int FBShowPage(PT_VideoBuf ptVideoBuf)
{
	if(g_tFBOpr.pucDispMem != ptVideoBuf->aucPixelDatas)
		memcpy(g_tFBOpr.pucDispMem, ptVideoBuf->aucPixelDatas, ptVideoBuf->iTotalBytes);
	return 0;
}
